...
// -----------------------------------------------------------------------------
// 1. Official Schedules for TRJT 3A (Fall Semester)
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// 3. Central Reminder Evaluation Engine
// -----------------------------------------------------------------------------
export async function runH10ReminderCheck({
  ...
  console.log(`[ReminderEngine Vercel] Run at: ${dateStr} ${timeStr} WIB (Day ${dayOfWeek}, DryRun: ${dryRun})`);
  ...
  // Fetch active registered devices
  const targetDevices = [];
  if (db) {
    try {
