const CACHE_NAME = 'trjt3a-reminder-v4.3';
const ASSETS = [
  './',
  './index.html',
  './css/design-system.css',
  './css/design-system.css?v=4.3',
  './js/firebase-config.js?v=4.3',
  './js/drive-service.js?v=4.3',
  './js/material-service.js?v=4.3',
  './js/time-provider.js?v=4.3',
  './js/data.js?v=4.3',
  './js/app.js?v=4.3',
  './manifest.json',
  './favicon.svg',
